...
- 亲和性调度(喜欢和哪个pod在一起)：NodeAffinity、PodAffinity、PodAntiAffinity
- 污点（容忍）调度（node可以设置污点，pod可以设置容忍度）：Taints、Toleration
...
pod.spec.affinity.nodeAffinity
  requiredDuringSchedulingIgnoredDuringExecution  Node节点必须满足指定的所有规则才可以，相当于硬限制
    nodeSelectorTerms  节点选择列表
      matchFields   按节点字段列出的节点选择器要求列表，只要有key就可以
...
![image-20220519173928300](https://markdown-1301334775.cos.eu-frankfurt.myqcloud.com/image-20220519173928300.png)
...
![image-20220519180306891](https://markdown-1301334775.cos.eu-frankfurt.myqcloud.com/image-20220519180306891.png)
